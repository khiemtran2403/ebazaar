...
//	}
	...
	public ObservableList<ProductPres> getProductLists(CatalogPres selectedCatalog) throws BackendException {
		List<ProductPres> list = manageProductsController.getProducts(selectedCatalog.getCatalog()).stream()
