							...
							<c:forEach var="catalogPres" items="${catalogs}">
								...
								<div class="col-lg-3 col-md-6">
									<div class="panel panel-primary">
										...
										<a
											href="${pageContext.request.contextPath}/viewProductList/catalogId/${catalogPres.id }/catalogName/${catalogPres.name }">
											<div class="panel-footer">
												<span class="pull-left">List Products</span> <span
													class="pull-right"><i
